...
urlpatterns = [
    ...
    path('login-success/', login_required(login_success), name='login_success'),
    path('logout/', login_required(auth_views.LogoutView.as_view(template_name='authentication/logout.html')), name='logout'),
    path('change-password/', login_required(auth_views.PasswordChangeView.as_view(template_name='authentication/change_password.html')), name='change_password'),
    path('change-password-done/', login_required(auth_views.PasswordChangeDoneView.as_view(template_name='authentication/change_password_done.html')), name='password_change_done'),
